...
const inputClass = 'h-[3.65rem] rounded-xl border border-[var(--slot4-navy)] bg-white px-5 text-base font-bold text-[var(--slot4-navy)] outline-none transition placeholder:text-slate-400 focus:border-[var(--slot4-blue)]'
const buttonClass = 'inline-flex h-[3.65rem] items-center justify-center rounded-full bg-[var(--slot4-blue)] px-6 text-sm font-black text-white transition hover:bg-[var(--slot4-navy)] disabled:opacity-60'
